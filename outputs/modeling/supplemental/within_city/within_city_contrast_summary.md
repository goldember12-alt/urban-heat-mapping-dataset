...
`city_prevalence_baseline` is a within-city-only contextual baseline and is not part of the canonical cross-city baseline suite.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Reno | hot_arid | city_prevalence_baseline | 0.1000 | n/a | n/a | 0.1050 | n/a | n/a |
...
| Charlotte | hot_humid | city_prevalence_baseline | 0.1000 | n/a | n/a | 0.1050 | n/a | n/a |
...
| Detroit | mild_cool | city_prevalence_baseline | 0.1000 | n/a | n/a | 0.1050 | n/a | n/a |
...
| --- | --- | --- |
| city_prevalence_baseline | n/a | n/a |
...
Figure: `C:\Users\golde\OneDrive - University of Virginia\STAT5630_FinalProject_DataProcessing\figures\modeling\supplemental\within_city\within_city_recall_contrast.png`
